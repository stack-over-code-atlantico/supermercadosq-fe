...
export function NavbarProducts() {
    ...
    return (
        <>
            {
                userLevel() && (userLevel().nivel === 'CLIENTE' || userLevel().nivel === 'FORNECEDOR') ? (
                    <DivNavbarProducts>
                        <NavbarList>
                            <ProductListItem>
                            ...
                            <ProductListItem>
                                <a href='' onClick={handleNavigateProfile}>Profile</a>
                            </ProductListItem>
                            <ProductListItem>
                                <a href='' onClick={handleNavigateProduct}>Postagens</a>
                            </ProductListItem>
                            <ProductListItem>
