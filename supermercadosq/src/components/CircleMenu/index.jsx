    ...
    <>
      <CircleDiv>
        ...
        <LabelMenu id="show-menu" htmlFor="toggle">
          <MainButton onClick={() => handleHome()} className="btn main-btn">
          ...
          <CircleButton onClick={() => handleHome()} className="btn">
            <CircleLink className="btn-icon">
              <IconsMenu src={homeIcon} />
            </CircleLink>
          </CircleButton>
          <CircleButton onClick={() => handleEgg()} className="btn">
            <CircleLink className="btn-icon">
              <IconsMenu src={eggIcon} />
            </CircleLink>
          </CircleButton>
          <CircleButton onClick={() => handleWheat()} className="btn">
            <CircleLink className="btn-icon">
              <IconsMenu src={wheatIcon} />
            </CircleLink>
          </CircleButton>
          <CircleButton onClick={() => handlePeanut()} className="btn">
            <CircleLink className="btn-icon">
              <IconsMenu src={peanutIcon} />
            </CircleLink>
          </CircleButton>
          <CircleButton onClick={() => handleMustard()} className="btn">
            <CircleLink className="btn-icon">
              <IconsMenu src={mustardIcon} />
            </CircleLink>
          </CircleButton>
          <CircleButton onClick={() => handleFish()} className="btn">
            <CircleLink className="btn-icon">
              <IconsMenu src={fishIcon} />
            </CircleLink>
          </CircleButton>
          <CircleButton onClick={() => handleSeafood()} className="btn">
            <CircleLink className="btn-icon">
              <IconsMenu src={seafoodIcon} />
            </CircleLink>
          </CircleButton>
          <CircleButton onClick={() => handleMilk()} className="btn">
            <CircleLink className="btn-icon">
